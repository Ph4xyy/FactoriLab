    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <WordmarkIcon className="h-5 text-foreground" />
          <span className="text-sm font-medium tracking-[0.18em] uppercase text-muted-foreground">
            Factorilab
          </span>
        </div>
        ...
        <div className="hidden items-center gap-2 md:flex">
          {links.map((link) => (
            <a
              ...
              className={buttonVariants({
                variant: "ghost",
                className:
                  "text-xs font-medium tracking-wide text-muted-foreground hover:text-foreground px-3",
              })}
              href={link.href}
            >
              {link.label}
          ...
          <Button className="text-xs font-medium tracking-wide">
            Book strategy call
          </Button>
        </div>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button className="w-full text-sm">Book strategy call</Button>
          </div>
        </div>
      </div>
    </header>
