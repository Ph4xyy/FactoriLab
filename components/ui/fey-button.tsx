...
const LockIcon = ({ className }: { className?: string }) => {
  ...
  const strokeColor =
    resolvedTheme === "dark" || resolvedTheme === undefined ? "#868F97" : "#4B5563"
  ...
  return (
    <button
      className={cn(
        ...
        "h-9 min-w-[160px] whitespace-nowrap rounded-[999px] px-4 py-2",
        "text-xs md:text-sm font-semibold tracking-wide",
        "text-foreground",
        isDark
          ? "bg-[radial-gradient(61.35%_50.07%_at_48.58%_50%,rgb(0,0,0)_0%,rgba(255,255,255,0.06)_100%)]"
          : "bg-[radial-gradient(61.35%_50.07%_at_48.58%_50%,rgb(255,255,255)_0%,rgba(0,0,0,0.04)_100%)]",
        isDark
          ? "[box-shadow:inset_0_0_0_0.5px_rgba(134,143,151,0.4),inset_1px_1px_0_-0.5px_rgba(134,143,151,0.6),inset_-1px_-1px_0_-0.5px_rgba(134,143,151,0.6)]"
        ...
        "after:absolute after:inset-0 after:rounded-[999px] after:opacity-0 after:transition-opacity after:duration-200",
        isDark
          ? "after:bg-[radial-gradient(61.35%_50.07%_at_48.58%_50%,rgb(7,7,7)_0%,rgb(18,18,18)_100%)]"
          : "after:bg-[radial-gradient(61.35%_50.07%_at_48.58%_50%,rgb(255,255,255)_0%,rgb(242,242,242)_100%)]",
        isDark
          ? "after:[box-shadow:inset_0_0_0_0.5px_hsl(var(--border)),inset_1px_1px_0_-0.5px_hsl(var(--border)),inset_-1px_-1px_0_-0.5px_hsl(var(--border)),0_0_3px_rgba(255,255,255,0.08)]"
